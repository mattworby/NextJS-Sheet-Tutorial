...
export default function Home() {
  return (
	...
	<div id="workMainBody">
		<div id="workMainRow1" className="workRow">
			<Link href="/twitch"><a onMouseEnter={() => showText('twitch','show')} onMouseLeave={() => showText('twitch','hide')}><div id="workMainTwitch" className="workLink"><h2 id="workTwitchText">Twitch</h2></div></a></Link>
			<Link href="/cat"><a onMouseEnter={() => showText('cat','show')} onMouseLeave={() => showText('cat','hide')}><div id="workMainCat" className="workLink"><h2 id="workCatText">Cat Game</h2></div></a></Link>
			<Link href="/equation"><a href="projects/equation.html" onMouseEnter={() => showText('equation','show')} onMouseLeave={() => showText('equation','hide')}><div id="workMainEquation" className="workLink"><h2 id="workEquationText">Equation Calculator</h2></div></a></Link>
		</div>
	</div>
